      ...
      body: GradientBackground(
        ...
        child: ListView(
          ...
          children: [
            ...
            _ColorSelector(themeProvider: themeProvider),
            const SizedBox(height: 32),

            _SectionHeader(title: 'Informații'),
            GlassCard(
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: const Text('Claude Code × JR Team'),
                  ),
                  const Divider(height: 1),
                  ListTile(
                    leading: Container(
                    ...
                    subtitle: const Text('Toate sistemele funcționale'),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 12),
                Text(
                  'Curent: ${AppColors.getColorName(themeProvider.accentColor)}',
