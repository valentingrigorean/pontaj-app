                            ...
                            Opacity(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: const Color(0xFF0F8D6E).withValues(alpha: 0.5),
                                      blurRadius: 80,
                                      spreadRadius: 20,
                                    ),
                                  ],
                          ...
                          child: SizedBox(
                            ...
                            child: ClipRRect(
                              ...
                              child: LinearProgressIndicator(
                                value: progress,
                                backgroundColor: Colors.grey[800]!.withValues(alpha: 0.2),
...
class _FloatingParticleState extends State<_FloatingParticle>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Positioned(
          left: MediaQuery.of(context).size.width * (_position.value.dx + 1) / 2,
...
class _JrLogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final gap = ui.lerpDouble(startGap, endGap, progress) ?? endGap;
    const segments = 8;
    final sweep = (2 * pi / segments) - gap;
    final rect = Rect.fromCircle(center: center, radius: radius);
    final stroke = ui.lerpDouble(radius * 0.45, radius * 0.18, progress) ??
        radius * 0.2;
